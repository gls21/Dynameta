...
### Version of ui.R script adapted to show how the option for subgroup analysis could be added into Dynameta 
...
# ******************* Add for subgroup analysis ************************************************************************************
                  ...
                  # Original text - comment this out
                  #p(h5("Based on your research question, you can filter the data by threat, location, taxonomic order, and biodiversity metric.")),
                  
                  # Text for version of Dynameta with sub-group analysis
